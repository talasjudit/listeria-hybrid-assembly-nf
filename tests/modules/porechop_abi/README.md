...
# Run the test
nextflow run tests/modules/porechop_abi/test_porechop_abi.nf -c nextflow.config -profile singularity,qib
```

With resume:

```bash
nextflow run tests/modules/porechop_abi/test_porechop_abi.nf -c nextflow.config -profile singularity,qib -resume
```
